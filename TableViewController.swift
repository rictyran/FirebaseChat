...
//  FirebaseChizzat
//
//  Created by Richard Tyran on 3/12/15.
...
class TableViewController: UITableViewController {
    ...
    @IBAction func sendMessage(sender: AnyObject) {
        ...
        firebaseRef.childByAppendingPath("messages").childByAppendingPath("\(Int(NSDate().timeIntervalSince1970))ric").setValue(["name":"ric","message":messageField.text])
    ...
    override func viewDidLoad() {
        ...
        //        firebaseRef.setValue("say something")
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.detailTextLabel?.text = message["name"] as? String
